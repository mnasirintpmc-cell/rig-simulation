...
# pages/app_separation_seal_p&id.py
import streamlit as st
from utils import find_file, load_json, render_system_image


st.set_page_config(layout="wide", page_title="Separation Area")


# load data
PID = find_file("p&id_separation_seal.png") or "assets/p&id_separation_seal.png"
VALVES = find_file("valves_separation_seal.json", ["data", "."]) or "data/valves_separation_seal.json"
PIPES = find_file("pipes_separation_seal.json", ["data", "."]) or "data/pipes_separation_seal.json"
...
st.success("Separation Area loaded — use sidebar controls to toggle valves.")
