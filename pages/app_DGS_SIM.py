...
# pages/app_DGS_SIM.py
import streamlit as st
from utils import find_file, load_json, render_system_image


st.set_page_config(layout="wide", page_title="DGS Area")


# load data
PID = find_file("p&id_dgs.png") or "assets/p&id_dgs.png"
VALVES = find_file("valves_dgs.json", ["data", "."]) or "data/valves_dgs.json"
PIPES = find_file("pipes_dgs.json", ["data", "."]) or "data/pipes_dgs.json"
...
st.success("DGS area loaded — use sidebar controls to toggle valves.")
