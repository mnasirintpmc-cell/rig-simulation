...
# pages/app_pressure_supply_p&id.py
import streamlit as st
from utils import find_file, load_json, render_system_image


st.set_page_config(layout="wide", page_title="Supply Area")


# load data
PID = find_file("p&id_pressure_in.png") or "assets/p&id_pressure_in.png"
VALVES = find_file("valves_pressure_in.json", ["data", "."]) or "data/valves_pressure_in.json"
PIPES = find_file("pipes_pressure_in.json", ["data", "."]) or "data/pipes_pressure_in.json"
...
st.success("Supply Area loaded — use sidebar controls to toggle valves.")
