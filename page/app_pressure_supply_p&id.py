...
# CHANGE THESE FOR EACH SYSTEM
SYSTEM_NAME = "Mixing Area"
PID_FILE = "P&ID_pressure_in.png"           # Your actual PNG
VALVES_FILE = "valves_pressure_in.json"     # Your valve positions
PIPES_FILE = "pipes_pressure_in.json"       # Your pipe coordinates

# PRESSURE SOURCES (edit per system)
PRESSURE_SOURCES = [1, 5]  # ← change per P&ID
...
def get_groups():
    return {
        1: [20], 2: [3,4,14,21,22], 5: [6,7,8,9,18], 11: [10,19],
        12: [], 13: [14,4,21,22], 17: [16,15,8], 22: [3,4,14,21]
    }
